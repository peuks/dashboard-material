...
// material-ui
import { Alert, Button, CardContent, Divider, Dialog, Grid, IconButton, Stack, Typography, Zoom } from '@material-ui/core';
                ...
                <Grid container spacing={gridSpacing}>
                    ...
                    <Grid item xs={12}>
                        <Grid container spacing={3} alignItems="center">
                            ...
                            <Grid item xs={6} sm={2} align="right" sx={{ display: { xs: 'block', sm: 'none' } }}>
                                <AnimateButton>
