...
import { Box, CardMedia, Grid, useMediaQuery } from '@material-ui/core';
...
const ProductImages = ({ product }) => {
    ...
    const settings = {
        ...
        focusOnSelect: true,
        centerPadding: '0px',
        slidesToShow: products.length > 3 ? noLG : products.length
    };
                ...
                <Grid item xs={12}>
                    <MainCard content={false} sx={{ m: '0 auto' }}>
                        <CardMedia
                            ...
                            component="img"
                            image={selected}
                            sx={{ borderRadius: `${customization.borderRadius}px`, overflow: 'hidden', cursor: 'zoom-in' }}
                        />
                    </MainCard>
                </Grid>
